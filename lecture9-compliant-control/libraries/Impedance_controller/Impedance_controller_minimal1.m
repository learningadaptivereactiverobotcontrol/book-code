...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function Impedance_controller_minimal1(robot,Impedance_Damping,Impedance_Stifness,External_force)
% close all
clc
...
figure1.Position = [0.335  * screensize(3), 0.1  * screensize(4), 0.6 * screensize(3), 0.8 * screensize(4)];  
axes1=subplot(3,1,1,'Parent',figure1);
title('Impedance controller without inertia reshaping', 'FontSize',12)
hold(axes1,'on');
box(axes1,'on');
grid(axes1,'on');
...
Tau=robot.Collios*robot.Dq+robot.Gravity+robot.Inertia*desired.DDq...
    -(desired.Damping*(robot.Dq-desired.Dq)...
