function [Data, Data_sh, att, x0_all, data, dt] = load_LASA_dataset_DS_so(sub_sample, nb_trajectories)
...
elseif n == 0
    ...
    for l=1:nb_trajectories
        ...
        data{l} = [demos{id_traj}.pos(:,1:sub_sample:end); demos{id_traj}.vel(:,1:sub_sample:end); demos{id_traj}.acc(:,1:sub_sample:end)];
        Data = [Data data{l}];
