...
for counter=1:25
    counter
    options.K=counter;  %Number of Gaussian funcitons
    ...
    ERROR_EM(counter)=MEAN_SQ_ER(DatA,Unstable_EM{counter}.prior,Unstable_EM{counter}.Mu,Unstable_EM{counter}.Sigma,Unstable_EM{counter}.A);
    ERROR_EM_T(counter)=MEAN_SQ_ER(DatA_T,Unstable_EM{counter}.prior,Unstable_EM{counter}.Mu,Unstable_EM{counter}.Sigma,Unstable_EM{counter}.A);
    ERROR_CON(counter)=MEAN_SQ_ER(DatA,Unstable_con{counter}.prior,Unstable_con{counter}.Mu,Unstable_con{counter}.Sigma,Unstable_con{counter}.A);
    ERROR_CON_T(counter)=MEAN_SQ_ER(DatA_T,Unstable_con{counter}.prior,Unstable_con{counter}.Mu,Unstable_con{counter}.Sigma,Unstable_con{counter}.A);
end
