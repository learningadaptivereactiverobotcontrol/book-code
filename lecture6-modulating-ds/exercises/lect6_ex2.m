...
f.Position = [0.05  * screensize(3), 0.2  * screensize(4), 0.8 * screensize(3), 0.5 * screensize(4)]; 
...
%%% TODO: uncomment and program a limit cycle

% x1 = ; % Coordinates of modulator
% sigma = ; % Kernel width for effect of modulator
% radius = ; % Radius of the limit cycle
...
%   'Modulated DS with limit cycle', 'streamslice', x1);

%% Exercise 2.2.2 - Unstable Point

% TODO : Uncomment and program an unstable point using M

% x1 = ; % Unstable point coordinate
% sigma = ; % Kernel width for effect of modulator
% 
% for i=1:nb_gridpoints
%     for j=1:nb_gridpoints
